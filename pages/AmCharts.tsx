...
export const AmCharts: React.FC = () => {
...
More info
  ...
  return (
    <div className="flex flex-col h-screen bg-[#121212]">
      <div id="chartcontrols" ref={chartControlsRef} className="w-full" style={{ minHeight: "60px" }}></div>
      <div id="chartdiv" ref={chartRef} className="flex-1 w-full" style={{ height: "calc(100vh - 60px)" }}></div>
    </div>
  );
};
